...
export const NuruApi = {
  ...
  async createPrayerWallPost(body: { post_id: string; title?: string | null; body: string; audio_url?: string | null; client_mutation_id?: string }): Promise<{ post_id: string }> {
  ...
  async prayerWallComment(postId: string, body: { comment_id: string; body: string; audio_url?: string | null; client_mutation_id?: string }): Promise<{ comment_id: string }> {
