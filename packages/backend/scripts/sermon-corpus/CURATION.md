...
| `Altars and Covenants` | Not a copyright problem like the others above — a volume/quality problem. A dry run of the extractor pulled 236 of 801 candidates (nearly 30%) from this one 86K-character document alone, and on inspection most were uncited Scripture narrative (the Cain-and-Abel dialogue, Genesis 8/17/28 word-for-word), the same "Ten brief observations" theological commentary already found copied into `Holy Communion`/`Covenants`, and pagan-mythology description ("Asherah was worshiped... including through ritual sex", "she was also his mistress"). Excluded wholesale rather than trying to keyword-filter a document this saturated. |
| `Faith` | Not a copyright or sensitivity problem — a "this isn't really his own words" problem. The document paraphrases nearly the entirety of Hebrews 11, verse by verse ("By faith Abel brought God a better offering than Cain did.", "Faith turns weakness into strength.") — close enough to the chapter's own wording and structure that surfacing these lines as the owner's own teaching would violate the same "never attribute Scripture to him" rule that governs verbatim quotation, just via paraphrase instead of exact wording. |
| `He is coming like a thief (PDF)` | A production/tooling problem, not a content problem. The source PDF's text extraction hard-wrapped mid-sentence with a blank line between each wrap (a PDF-to-text artifact — the other 30 documents are Google Docs and don't have this), so the block splitter (which treats a blank line as a paragraph boundary) sees every wrap as its own paragraph. Every single extracted candidate from this file was a sentence fragment cut off mid-clause ("The world will not know about his coming – only those who are prepared for Jesus will."). Excluded wholesale rather than trying to reflow hard-wrapped PDF text. |
